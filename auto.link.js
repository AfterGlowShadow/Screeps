var autoLink = {
    ...
    run: function() {
        ...
        if (Game.getObjectById('5e5374800a99ae4be2286c7a').store.getUsedCapacity(RESOURCE_ENERGY) > 200) {
            Game.getObjectById('5e5374800a99ae4be2286c7a').transferEnergy(Game.getObjectById('5e648a81356a961615dd55c6'), Game.getObjectById('5e5374800a99ae4be2286c7a').store.getUsedCapacity(RESOURCE_ENERGY) - 200);
        }
